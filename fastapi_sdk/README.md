...
with fastapi_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Read Item
        api_response = api_instance.read_item_items_item_id_get(item_idquery_param=query_param)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**read_item_items_item_id_get**](docs/apis/tags/DefaultApi.md#read_item_items_item_id_get) | **get** /items/{item_id} | Read Item
...
If the OpenAPI document is large, imports in fastapi_sdk.apis and fastapi_sdk.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from fastapi_sdk.apis.default_api import DefaultApi`
...
import fastapi_sdk
from fastapi_sdk.apis import *
from fastapi_sdk.models import *
```
