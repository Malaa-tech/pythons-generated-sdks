# auth-sdk-v1beta
This is an exsssample of how to use the FastAPI SDK
...
query_param = "query_param_example" # str |  (optional)
    ...
    try:
        # Read Item
        api_response = api_instance.get_item(item_idquery_param=query_param)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**get_item**](docs/apis/tags/DefaultApi.md#get_item) | **get** /items/{item_id} | Read Item
...
If the OpenAPI document is large, imports in auth_sdk_v1beta.apis and auth_sdk_v1beta.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from auth_sdk_v1beta.apis.default_api import DefaultApi`
- `from auth_sdk_v1beta.model.pet import Pet`
...
import auth_sdk_v1beta
from auth_sdk_v1beta.apis import *
from auth_sdk_v1beta.models import *
```
